...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "qrstatus" */ '../views/landingPage/QRStatus.vue'
          )
      }
    ]
  },
  ...
  {
    path: '/signupfederated',
    name: 'SignUpFederated',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(
        /* webpackChunkName: "Signupfederated" */ '../views/SignupFederated.vue'
      )
  },
  {
    path: '/invoice',
